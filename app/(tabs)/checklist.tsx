      ...
      >
        ...
        <View style={styles.macroSummary}>
          <View style={styles.macroItem}>
            <Text style={styles.macroValue}>{fmtInt(BASELINE.calories, "--")}</Text>
